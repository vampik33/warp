...
use super::{
    autotracking, ActionHandlersByName, AddWindowOptions, AnyView, Backend, BlurContext,
    FocusContext, GlobalActionCallback, GlobalShortcut, InvalidationCallback, Observation,
...
pub struct AppContextImpl<B: Backend> {
    ...
    ////////////////////////////////
    actions: HashMap<TypeId, ActionHandlersByName<B>>,
    ...
    typed_actions: HashMap<ActionType, HashMap<ViewType, Box<TypedActionCallback<B>>>>,
    ...
    /// GUI: `GuiPresenterState`; TUI: empty `TuiPresenterState`.
...
/// never mention `B`; the backend is projected through the module-routed
/// `backend::Active` alias. A build is GUI **xor** TUI.
pub type AppContext = AppContextImpl<super::backend::Active>;
