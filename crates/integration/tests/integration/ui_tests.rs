...
integration_tests! {
    ...
    test_nav_stack_feature_flag_gates_bindings_and_buttons,
    test_nav_stack_navigation_buttons_setting_toggle,
    test_nav_stack_command_palette_back_forward,
    test_nav_stack_command_palette_clear,
    test_nav_stack_clear_command_preserves_tab_and_scroll_context,
    test_nav_stack_clear_command_preserves_focused_pane,
    test_nav_stack_clear_command_allows_new_history_afterward,
    test_nav_stack_tab_switch_records_and_restores,
    test_nav_stack_tab_bar_buttons_navigate,
    ...
    test_nav_stack_scroll_updates_back_button_state,
